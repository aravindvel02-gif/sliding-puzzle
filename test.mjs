import { createSolvedBoard, canMoveTile, moveTile, isSolved, getMovableIndices, moveDirection } from "./src/puzzle.js";
import { shuffleBoard, mulberry32, seedFromDateString } from "./src/shuffle.js";
